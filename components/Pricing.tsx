    ...
    <section id="pricing" className="py-20 bg-neutralLight">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          {/* Starter */}
          <div className="bg-white rounded-2xl p-8 border border-gray-100 hover:shadow-xl transition-shadow flex flex-col">
            ...
            <div className="mb-6">
              <span className="text-4xl font-bold text-neutralDark">${annual ? '299' : '349'}</span>
              <span className="text-gray-500">/mo</span>
            </div>
            <Button variant="outline" className="w-full text-primary border-primary hover:bg-primary hover:text-white mb-8">Start Free Trial</Button>
          ...
          {/* Growth - Popular */}
          <div className="bg-white rounded-2xl p-8 border-2 border-primary shadow-2xl relative transform md:-translate-y-4 flex flex-col">
            ...
            <h3 className="text-xl font-bold text-neutralDark mb-2">Growth</h3>
            <p className="text-sm text-gray-500 mb-6">For growing teams needing automation.</p>
            <div className="mb-6">
              <span className="text-4xl font-bold text-neutralDark">${annual ? '599' : '699'}</span>
              <span className="text-gray-500">/mo</span>
            </div>
          ...
          {/* Enterprise */}
          <div className="bg-white rounded-2xl p-8 border border-gray-100 hover:shadow-xl transition-shadow flex flex-col">
            <h3 className="text-xl font-bold text-neutralDark mb-2">Enterprise</h3>
            <p className="text-sm text-gray-500 mb-6">For large organizations with strict compliance.</p>
            <div className="mb-6">
              <span className="text-4xl font-bold text-neutralDark">Custom</span>
            </div>
